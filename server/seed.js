...
const lines = [
    { name: "Red Line", stations: ["Centrale", "Porta Velaria", "Crocevia del Falco", "Piazza delle Lanterne"] },
    { name: "Blue Line", stations: ["Fontana Oscura", "Borgo Sereno", "Crocevia del Falco", "Viale dei Mosaici"] },
